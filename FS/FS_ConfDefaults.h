...
*/
  ...
  #define FS_BUFFER_SIZE_VERIFY                   128   // Size of the work buffer allocated on the stack by FS_Verify()
#endif
  ...
  #define FS_BUFFER_SIZE_FILE_COPY                512   // Size of the buffer used by FS_CopyFile(). This buffer is allocated on stack.
#endif

#ifndef   FS_BUFFER_SIZE_FILE_WIPE
  #define FS_BUFFER_SIZE_FILE_WIPE                512   // Size of the buffer used by FS_WipeFile(). This buffer is allocated on stack.
#endif

#ifndef   FS_BUFFER_SIZE_TRUNCATE
  #define FS_BUFFER_SIZE_TRUNCATE                 512   // Size of the buffer used by FS_Truncate(). This buffer is allocated on stack.
#endif
...
*/
  ...
  #define FS_FAT_OPTIMIZE_LINEAR_ACCESS           1     // Improves the performance when accessing files with clusters allocated linearly.
#endif
...
*/
  ...
  #define FS_EFS_OPTIMIZE_LINEAR_ACCESS           1     // Improves the performance when accessing files with clusters allocated linearly.
#endif
...
*/
  ...
  #define FS_NAND_SUPPORT_BLOCK_GROUPING          1     // If set to 1 the driver handles two or more adjacent physical NAND blocks as a single block to reduce the RAM usage.
...
*/
  ...
  #define FS_NOR_DEVICE_LIST_DEFAULT              &FS_NOR_SPI_DeviceListDefault     // Default list of recognized serial NOR flash devices.
#endif
