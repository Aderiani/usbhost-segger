...
*       FS_DIR
*/
struct FS_DIR {                       //lint -esym(9058, FS_DIR) tag unused outside of typedefs. Rationale: the type definition is used as forward declaration.
  FS_DIR_OBJ   DirObj;
  FS_DIRENT  * pDirEntry;
  U8           InUse;
};
...
extern const FS_NOR_SPI_TYPE FS_NOR_SPI_DeviceMacronixOctal;
...
*/
typedef struct FS_NAND_ONFI_DEVICE_TYPE FS_NAND_ONFI_DEVICE_TYPE;       //lint -esym(9058, FS_NAND_ONFI_DEVICE_TYPE) tag unused outside of typedefs. Rationale: this is an opaque data type.
